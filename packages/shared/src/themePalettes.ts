...
export const THEME_COLOR_ROLES = [
  ...
  // Turbo region roles: menus, sidebar cards, and the composer follow the
  // palette that owns them.
  "menuSurface",
  "menuForeground",
  "menuBorder",
  "menuItemHover",
...
// Turbo: region roles derive from base roles when a palette does not set
// them explicitly, so palettes authored before a region role existed keep
// following their own colors.
export const REGION_THEME_ROLE_SOURCES = {
...
/** Fills any region role the palette did not set from its fallback source. */
...
export const T3_CODE_LIGHT_THEME_COLORS: ThemeColors = {
  ...
  menuSurface: "#ffffff",
  menuForeground: "#27272a",
  menuBorder: "#e4e4e7",
  menuItemHover: "#f4f4f5",
  menuItemHoverForeground: "#18181b",
  menuSeparator: "#e4e4e7",
  sidebarCardSurface: "#f4f4f5",
  sidebarCardBorder: "#e4e4e7",
  sidebarCardTitle: "#27272a",
  sidebarCardMeta: "#71717b",
  composerSurface: "#fcfcfc",
  composerForeground: "#27272a",
  composerPlaceholder: "#71717b",
  composerBorder: "#e4e4e7",
  composerControl: "#ffffff",
  composerControlForeground: "#27272a",
};
...
export const T3_CODE_DARK_THEME_COLORS: ThemeColors = {
  ...
  menuBorder: "#191919",
  menuItemHover: "#141414",
  menuItemHoverForeground: "#f5f5f5",
  menuSeparator: "#191919",
  sidebarCardSurface: "#0a0a0a",
  sidebarCardBorder: "#141414",
  sidebarCardTitle: "#f1f3f7",
  sidebarCardMeta: "#a3a3a3",
  composerSurface: "#111111",
  composerForeground: "#f5f5f5",
  composerPlaceholder: "#818181",
  composerBorder: "#191919",
  composerControl: "#111111",
  composerControlForeground: "#f5f5f5",
};
