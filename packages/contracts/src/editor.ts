...
// Turbo: system-default open + external-launcher error contracts.
...
export class ExternalLauncherInvalidPathError extends Schema.TaggedError<ExternalLauncherInvalidPathError>()(
...
export class ExternalLauncherDefaultAppSpawnError extends Schema.TaggedError<ExternalLauncherDefaultAppSpawnError>()(
