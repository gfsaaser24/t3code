...
your laptop, follow [Headless VPS environment](../../infra/headless-vps.md). That guide covers
always-on Linux hosts with T3 Connect, the background service, Tailscale, and SSH end to end. This
page is the reference for pairing, endpoints, and access methods.
