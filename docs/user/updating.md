...
For remote connection setup and access troubleshooting, see
[Remote access](./remote-access.md). For standing up an always-on Linux host as the working
environment, see [Headless VPS environment](../../infra/headless-vps.md).
