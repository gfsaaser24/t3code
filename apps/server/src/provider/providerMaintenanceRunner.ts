            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but T3 Turbo could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but T3 Turbo still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
