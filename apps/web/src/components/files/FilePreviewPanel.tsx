...
export default function FilePreviewPanel({
  ...
  // Turbo: the markdown preference is the shared pretty/code mode, not a local flag.
  const renderMarkdown = isMarkdown && markdownPreviewMode === "pretty" && revealHandled;
  ...
  const setRenderedPreferred = isMarkdown
    ? (pressed: boolean) => setMarkdownPreviewMode(pressed ? "pretty" : "code")
