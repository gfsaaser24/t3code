...
/**
 * The one canonical activity order, shared with the store, web, and the
 * server's `ORDER BY` clauses. Re-exported here so mobile call sites keep
 * importing it from this module and the four copies cannot drift apart again.
 */
