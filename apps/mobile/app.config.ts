...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSPhotoLibraryAddUsageDescription: `Allow ${MOBILE_PRODUCT_NAME} to save images to your photo library.`,
  ...
  plugins: [
    ...
    [
      "expo-audio",
      {
        microphonePermission: "Allow T3 Turbo to use your microphone for voice input.",
